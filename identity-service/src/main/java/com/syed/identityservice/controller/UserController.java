...
public class UserController {
    ...
    public ResponseEntity<UserV2PageResponse> getUserList(
        ...
        return new ResponseEntity<>(userService.getUserList(size, cursor), HttpStatus.OK);
    }
    ...
    public ResponseEntity<UserV2PageResponse> getUserListByApp(
            @RequestHeader(value = "x-correlation-id", required = true) String correlationId,
        ...
        return new ResponseEntity<>(userService.getUserListByApp(appId, appName, size, cursor), HttpStatus.OK);
    }
